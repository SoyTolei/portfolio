...
const translations = {
    es: {
        ...
        hero_cta_cv: 'CV',
        hero_stat1_val: '4',
        hero_stat1_lbl: 'módulos ST2',
        hero_stat2_val: 'SQL',
        hero_stat2_lbl: 'Server · T-SQL',
        hero_stat3_val: '.NET',
        hero_stat3_lbl: 'C# · Python',
        chip_sql: 'SQL Server',
        chip_dotnet: '.NET',
        chip_python: 'Python',
        chip_csharp: 'C#',
        ...
        about_p3: 'Para la mesa de ayuda armé <strong>ST2</strong> — <strong>S</strong>oluciones <strong>T</strong>ecnológicas: herramientas propias para que el agente trabaje más cómodo y consistente. Empezó con un .bat de mantenimiento; hoy suma exe, backup de bases y versión web en <strong>C# / .NET</strong>. No son productos oficiales de TR.',
    ...
    en: {
        ...
        about_p3: 'For the help desk I built <strong>ST2</strong> — <strong>T</strong>echnical <strong>S</strong>olutions: personal tools so agents can work more comfortably and consistently. Started with a maintenance .bat; today includes a desktop app, database backup and web version in <strong>C# / .NET</strong>. Not official TR products.',
        note_label: '// why ST2',
