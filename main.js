...
const translations = {
    es: {
        ...
        term_out3: '5 módulos activos · desktop + web · uso diario en soporte',
        hero_cta_projects: 'Ver proyectos',
        hero_cta_cv: 'CV',
        hero_photo_cap: 'Soporte que construye herramientas',
        ...
        proj_st2_badge: 'Desktop',
        proj_st2_p1: 'Exe principal del soporte: documentación de casos, conocimiento técnico y recursos web en un solo lugar.',
        ...
        proj_planillas_badge: 'Python · origen',
        proj_planillas_p1: 'Primera versión del generador de casos: formularios que arman el texto del ticket listo para pegar en el sistema de incidencias.',
    ...
    en: {
        ...
        term_out2: 'sql-server · t-sql · csharp · dotnet · python · powershell',
        term_cmd3: 'st2 status',
        term_out3: '5 active modules · desktop + web · daily use in support',
        hero_cta_projects: 'View projects',
        hero_cta_cv: 'CV',
        hero_photo_cap: 'Support that builds tools',
        ...
        proj_planillas_title: 'Sistema de Planillas',
        proj_planillas_badge: 'Python · origin',
        proj_planillas_p1: 'First version of the case generator: forms that build ticket text ready to paste into the incident system.',
