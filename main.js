...
const translations = {
    es: {
        ...
        about_p2: 'En <strong>Thomson Reuters</strong> doy soporte técnico de <strong>Bejerman</strong> a empresas y estudios contables — instalación de sistemas, SQL Server y consultas en entornos de producción.',
    ...
    en: {
        ...
        about_p2: 'At <strong>Thomson Reuters</strong> I provide technical support for <strong>Bejerman</strong> to companies and accounting firms — system installs, SQL Server and queries in production environments.',
